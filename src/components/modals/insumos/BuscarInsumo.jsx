...
const BuscarInsumo = ({listaInsu, buscarIdInsumo }) => {
    ...
    console.log('Datos recibidos:', listaInsu);
    const CrearTabla = async () => {
        let table = new DataTable('#tablaInsumos', {
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    createdCell: (td, cellData, rowData, row, col) => {
                        ...
                        root.render(
                            <Button value={rowData.id} onClick={e => seleccionInsumo(e, "value")}>Selecionar</Button>
                        );
                    }
                },
            ],
            ...
            drawCallback: function () {
                $('.dataTables_filter').find("[aria-controls='tablaInsumos']").addClass('form-control');
                $('.paginate_button').addClass('btn btn-outline-dark page-item');
            }
        });
    }

    const seleccionInsumo = (e) => {
        ...
        <div className="input-group-prepend">
            ...
            <Modal show={verModal} onHide={cerrarModal} className="modal fade" size="lg">
                <div className="modal-header modal-primary">
                    <h4 className="modal-title text-primary">Buscar Insumo</h4>
                    <button
                        type="button"
                        className="close"
                        data-dismiss="modal"
