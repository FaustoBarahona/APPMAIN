...
const SideNav = () => {
 ...
 >
   ...
   <ul className="nav nav-treeview">
     <li className="nav-item">
       <Link to="/app/insumos/" className="nav-link"> 
         <i className="far fa-circle nav-icon" />
         Insumos 
       </Link>
     </li>
     {/* Opción de compra de insumos */}
     <li className="nav-item">
       <Link to="/app/comprainsumos" className="nav-link">
         <i className="far fa-circle nav-icon" />
         Compra Insumos
       </Link>
     </li>
...
>
  ...
  <ul className="nav nav-treeview">
    <li className="nav-item">
      ...
      <li className="nav-item">
        <Link to="/app/salidainventario" className="nav-link">
          <i className="far fa-circle nav-icon" />
          Salida Inventario
        </Link>
    </li>
